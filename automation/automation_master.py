...
class CigarPriceAutomationEnhanced:
    ...
    def sync_to_git(self) -> bool:
        ...
        try:
            ...
            # Add the entire static/data directory (including subdirectories) - FIXED
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'manual':
        ...
        try:
            ...
            # Daily trigger at 2:15 PM PST
            scheduler.add_job(
                automation.run_full_update,
                trigger=CronTrigger(hour=14, minute=15, timezone='America/Los_Angeles'),
                id='price_update_job'
            )
            
            logger.info("Automation scheduled - Daily updates at 2:15 PM Pacific time")
